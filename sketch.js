...
//VARIABLES PARA winning, lose y explosionSound (sonido de explosion)
...
if(zombieGroup.isTouching(bulletGroup)){
  for(var i=0;i<zombieGroup.length;i++){     
   ...
   if(zombieGroup[i].isTouching(bulletGroup)){
        ...
        //añadir sonido y aumentar el score
...
if(zombieGroup.isTouching(player)){
 ...
 for(var i=0;i<zombieGroup.length;i++){     
  ...
  if(zombieGroup[i].isTouching(player)){
       ...
       //Reducir la vida del jugador cuando lo toca el zombie
...
//ajustar tamaño del texto y llenarlo de blanco
